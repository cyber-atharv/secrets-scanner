	...
	return &types.ScanResult{
		Findings: []types.Finding{
			{ //nolint:gosec
				...
				Match:       `AKIA_DUMMY_TEST_KEY_FOR_SCANNER_00`,
				Secret:      "AKIA_DUMMY_TEST_KEY_FOR_SCANNER_00",
				FilePath:    "src/config.py",
				LineNumber:  42,
				LineContent: `aws_key = "AKIA_DUMMY_TEST_KEY_FOR_SCANNER_00"`,
...
func TestJSONReport(t *testing.T) {
	...
	assert.NotContains(t, output.Findings[0].Secret, "AKIA_DUMMY_TEST_KEY_FOR_SCANNER_00")
