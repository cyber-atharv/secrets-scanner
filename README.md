...
[![Cybersecurity Projects](https://img.shields.io/badge/Cybersecurity--Projects-Project%20%2316%20intermediate-red?style=flat&logo=github)](https://github.com/cyber-atharv/Cybersecurity-Projects/tree/main/PROJECTS/intermediate/secrets-scanner)
...
```bash
curl -fsSL https://raw.githubusercontent.com/cyber-atharv/portia/main/install.sh | bash
```

Or with Go:

```bash
go install github.com/cyber-atharv/portia/cmd/portia@latest
```
